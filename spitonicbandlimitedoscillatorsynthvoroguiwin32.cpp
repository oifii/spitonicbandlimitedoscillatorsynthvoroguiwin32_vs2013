...
#include "stdafx.h"
#include "spitonicbandlimitedoscillatorsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicbandlimitedoscillatorsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicbandlimitedoscillatorsynthvoroguiwin32class"};				// the main window class name
